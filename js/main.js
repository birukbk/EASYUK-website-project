...
//Use smooth scrolling when clicking on navigation
  $('.navbar a[href*=#]:not([href=#]),.carousel-caption a[href*=#resources],.totop').click(function() {
  ...
  $("#blog,#resources,#gallery,#about,#contact,#events,.carousel-indicators,.carousel-control").velocity({ opacity: 0 });
  ...
  var ctrl = new ScrollMagic.Controller({
    ...
    var scene2 = new ScrollMagic.Scene({triggerElement: '#resources'}).setVelocity('#resources',{opacity:1}).setVelocity('#resources','transition.slideUpBigIn').addTo(ctrl);
    ...
    var scene3 = new ScrollMagic.Scene({triggerElement: '#gallery'}).setVelocity('#gallery',{opacity:1}).setVelocity('#gallery','transition.slideRightIn').addTo(ctrl);
    var scene4 = new ScrollMagic.Scene({triggerElement: '#events'}).setVelocity('#events',{opacity:1}).setVelocity('#events','transition.fadeIn').addTo(ctrl);
